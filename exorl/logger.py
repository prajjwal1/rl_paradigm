...
class Logger(object):
    def __init__(self, log_dir, use_tb, offline=False):
        ...
        self._train_mg = MetersGroup(log_dir / "train.csv", formating=TRAIN_FORMAT)
        self._eval_mg = MetersGroup(log_dir / "eval.csv", formating=EVAL_FORMAT)
        if use_tb:
