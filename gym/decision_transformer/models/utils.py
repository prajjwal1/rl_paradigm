...
def get_normalized_scores(env, score):
    if env == "hopper":
        random_score, expert_score = -20.272305, 3234.3
    if env == "halfcheetah":
        random_score, expert_score = -280.178953, 12135.0
    if env == "walker2d":
        random_score, expert_score = 1.629008, 4592.3
    if env == "humanoid":
        random_score, expert_score = 123, 9115

    normalized_score = (score - random_score) / (expert_score - random_score) * 100
