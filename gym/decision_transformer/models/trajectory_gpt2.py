...
class Attention(nn.Module):
    ...
    def _attn(
        ...
        #          print(f'nd : {nd}')
        #  print(f'ns: {ns}')
        #  print(f'q: {q.shape}') # [bs, n_heads, seq_len*3, embed_dim//n_heads]
        #  print(f'k: {k.shape}') # [bs, n_heads, embed_dim//n_heads, seq_len*3]
        #  print(f'v: {v.shape}') # [bs, n_heads, seq_len*3, embed_dim//n_head]
        #  print(f'am: {attention_mask.shape}') # [bs, 1, 1, seq_len*3]]
        #  #  print(f'hm: {head_mask.shape}')
        #          print()
        ...
        if not self.is_cross_attention:
            ...
            #  print(f'self.masked_bias: {self.masked_bias.shape}')
    ...
    def forward(
        ...
        #          print(f"q before: {query.shape}") # [bs, seq_len*3, embed_dim]
        #  print(f"k before: {key.shape}") # [bs, seq_len*3, embed_dim]
        #          print(f"v before: {value.shape}") # [bs, seq_len*3, embed_dim]
